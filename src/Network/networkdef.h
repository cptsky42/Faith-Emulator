...
/** Maximum length of an extended name, including the NUL character. */
const size_t MAX_NAMESIZE_CLI = 32;
...
const uint16_t MSG_LOGINREPLYEX     = MSG_GENERAL + 55;
const uint16_t MSG_LOGINACCOUNTEX   = MSG_GENERAL + 90;
