...
#define STR_SYN_NOTENOUGH_PROFFER_LEAVE     "You have to donate 20'000 before leaving the legion."
#define STR_SYN_LEAVE                       "%s has leaved the legion."
...
#define STR_NOT_SELL_ENABLE			"You can't sell this item."
...
#define	STR_BOOTH_BUY               "%s has payed you %u for %s!"
...
#define STR_JOIN_SYN                "%s has joined the legion."
#define	STR_KICKOUT_MEMBER          "%s doesn't respect the rules and he has been kicked out."
...
#define	STR_ARRESTMENT_PK_MODE		"In arrestment mode, you can only attack monsters and black name players."
#define STR_SYNDICATE_PK_MODE       "ÆïÊ¿ÍÅPKÄ£Ê½£¬Äã¿ÉÒÔPKËùÓÐ³ý±¾ÍÅ¼°Í¬ÃËÆïÊ¿ÍÅÖ®ÍâµÄÍæ¼Ò¡£"
#define	STR_TEAM_PK_MODE			"In team mode, you can attack everybody, except your friends, your teammates, and your legionmates."
#define	STR_SAFE_PK_MODE			"In safe mode, you can only attack monsters."
#define	STR_FREE_PK_MODE			"In free mode, you can attack everybody."
#define	STR_NEED_PICK				"±ØÐëÒª×°±¸³úÍ·²ÅÄÜÍÚ¿ó¡£"
#define	STR_SYNDICATE_DESTROY       "The legion %s has been disbanded."
#define	STR_SYNDICATE_CREATE        "%s has created %s!"
#define	STR_SYN_LEADER_LOSE_uss		"ÆïÊ¿ÍÅ[%u][%s]ÆïÊ¿ÍÅ³¤Ê§×Ù£¬Íæ¼Ò[%s]ÔÝ´úÆïÊ¿ÍÅ³¤Ö®Ö°¡£"
#define	STR_DONATE                  "%s has donated %u silvers to the legion."
...
#define	STR_NOT_SO_MUCH_MONEY	    "You don't have enough money."
#define	STR_NOT_ENOUGH_MONEY	    "ÄãµÄÇ®²»×ã%d½ð±Ò!"
#define	STR_ATTACK_POLICE	        "¸óÏÂÉæÏÓÏ®¾¯£¬ÇëºÃ×ÔÎªÖ®£¬ÒÔÃâÈÇ»ðÉÏÉí¡£"
#define	STR_KILLING_EXPERIENCE	    "You got %d exp points by killing a monster."
#define	STR_KILLING_EXPEX			"»ñµÍµÈ¼¶¶ÓÓÑ½±ÀøºÍ»÷É±¶îÍâ¾­Ñé%u¡£"
#define	STR_BAG_FULL	            "±³°üÒÑÂú!"
#define	STR_TRADE_SUCCEED	        "The trade is a success."
#define	STR_TRADE_FAIL	            "The trade has failed."
#define	STR_USE_ITEM	            "ÄúÓÃµôÁËÒ»¼þÎïÆ·¡£"
#define	STR_INVALID_legion_NAME		"ÆïÊ¿ÍÅÃû×Ö²»ºÏ·¨!"
#define	STR_legion_FUND_NOT_ENOUGH	"ÆïÊ¿ÍÅ»ù½ð²»×ã%u½ð±Ò!"
...
#define	STR_NO_DISBAND              "You can't disband the guild."
...
#define	STR_FORBIDDEN_legion_NAME	"Äú²»ÄÜÊ¹ÓÃÕâ¸öÆïÊ¿ÍÅÃû¡£"
#define	STR_legion_INEXIST	        "¸ÃÆïÊ¿ÍÅ²»´æÔÚ¡£"
#define	STR_TEAM_EXPERIENCE	        "You got %d exp points with your team."
...
#define	STR_ITEM_NOT_FOUND	        "The specified item wasn't found."
#define	STR_ITEM_INEXIST	        "The item doesn't exist."
#define	STR_MONEYBAG_FULL	        "ÄúµÄÇ®´üÒÑÂú!"
#define	STR_MAKE_ITEM_FAILED        "²úÉúµØÍ¼ÎïÆ·[%u]Ê§°Ü¡£"
#define	STR_MAKE_MONEY_FAILED	    "Error: Can't create the money. [%d]"
#define	STR_DAMAGED_REPAIR	        "%s¼´½«Ëð»µ£¬Çë¾¡¿ìÐÞ¸´£¬·ñÔò½«³¹µ×ÏûÊ§!"
#define	STR_DURABILITY_REPAIR	    "%sÄÍ¾Ã¶ÈÌ«µÍ£¬Çë¾¡¿ìÐÞ¸´£¬ÒÔÃâËðÉË¡£"
#define	STR_FAR_CANNOT_PICK	        "The item is too far."
#define	STR_FULL_CANNOT_PICK	    "Your inventory is full!"
#define	STR_PICK_MONEY	            "You got %u silvers."
#define	STR_FAILED_GENERATE_ITEM	"²úÉúÎïÆ·Ê§°Ü¡£"
#define	STR_OTHERS_ITEM	            "You can't take this item for the moment."
#define	STR_GOT_ITEM	            "You got %s."
#define	STR_GOT_IDENT_ITEM	        "µÃµ½Î´¼ø¶¨ÎïÆ·¡£"
#define	STR_DRAGONBALL	            "Congradulation! %s got a DragonBall!"
...
#define	STR_MINE_WITH_PECKER   	    "You need a pecker to mine."
#define	STR_NO_MINE	                "You can't mine here."
#define	STR_GOLD_ORE                "You mined a gold ore!"
#define	STR_EUXENITE_ORE            "You mined an euxenite ore!"
#define	STR_IRON_ORE                "You mined an iron ore!"
#define	STR_COPPER_ORE              "You mined a copper ore!"
#define	STR_SILVER_ORE              "You mined a silver ore!"
#define	STR_GAIN_GEM                "You mined a gem!"
#define	STR_UNQUALIFIED	            "´íÎó£ºÌõ¼þ¼ì²éÊ§°Ü£¡"
#define	STR_DIE                     "You're dead !"
#define	STR_DONOT_GIVE_UP	        "¸óÏÂÉí¸ºÖØÈÎ£¬Ôõ¿É×Ô±©×ÔÆú£¿"
#define	STR_CANNOT_JUMP             "You can't jump."
#define	STR_CHEAT	                "[×÷±×]ÄãÒª·ÖÅäµÄµãÊý´óÓÚÓµÓÐµÄ¿É·ÖÅäµãÊý¡£"
#define	STR_FRIEND_LIST_FULL	    "Your friend list is full!"
#define	STR_YOUR_FRIEND_ALREADY	    "The target is already your friend!"
...
#define	STR_NOT_ENOUGH_MANA	        "Not enough mana."
#define	STR_UNABLE_USE_ITEM	        "Unable to use the item."
...
#define	STR_KICK_OUT_legion	        "%s ÒÑ¾­±»¿ª³ý³öÆïÊ¿ÍÅ£¡"
...
#define	STR_TEAM_FULL			    "The team is already full."
...
#define	STR_TEAM_CLOSED	            "You can't join this team."
...
#define	STR_NO_TRADE_TARGET	        "You don't have a target to trade with."
#define	STR_TARGET_TRADING	        "The player is already trading."
#define	STR_TRADING_REQEST_SENT	    "The trade request has been sent."
#define	STR_NOT_FOR_TRADE	        "You can't trade this item."
...
#define	STR_JOIN_A_legion	        "%s ¼ÓÈëÁË°ïÅÉ¡£"
...
#define	STR_MARRY					"%s and %s are now married!"
...
#define STR_TOOMUCH_MONEY           "You have too much money."
#define STR_TOOMUCH_MONEY_TO_DRAW   "ÄúÉíÉÏÇ®Ì«¶àÁË£¬²»¿ÉÒÔÔÙÈ¡¡£"
#define STR_NOT_ENOUGH_POTENTIAL    "ÄúµÄÇ±ÄÜÖµ²»×ã£¬ÎÞ·¨Ê¹ÓÃ½á½ç¡£"
#define STR_BOOTH_FULL              "Your booth is full!"
#define STR_TUTOR_LOGIN             "ÄúµÄÊ¦¸µ%sÀ´µ½ÁË¡¾Ä§Óò¡¿¡£"
#define STR_TUTOR_LOGOUT            "ÄúµÄÊ¦¸µ%sÀë¿ªÁË¡¾Ä§Óò¡¿¡£"
#define STR_DROP_MONEY_SUCC         "You have droped %u silvers."
#define STR_DIE_DROP_MONEY          "You're dead. You can't drop money."
